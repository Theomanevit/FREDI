<?php
    ...
    $test_adherant ='INSERT into adherant (id_adherant, adresse, cp, id_club, id_util, num_licence, ville) values (1 ,"chez moi", 44240, 1, 1, 11111, "sucé sur erdre")'; 

    $test_notefrais ='INSERT INTO notefrais (id_nfrais, date_ordre, id_adherant, id_fisc, isvalid, num_ordre, tot_nfrais) VALUES (1 ,"2022/02/02", 1, 1, 1, 1, 1)';
