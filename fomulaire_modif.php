            ...
            <div class="formbg-inner padding-horizontal--48">
                <form action="<?php echo $_SERVER['PHP_SELF'].'?id_nfrais='.$id_nfrais.'';?>" method="post">
                    <div class="field padding-bottom--24">
                        ...
                        <input type="text" name="lib_deplace" id="lib_deplace" value="<?php echo $lib_deplace ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Date du deplacement</label>
                        <input type="date" name="date_deplace" id="date_deplace" value="<?php echo $date_deplace ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Frais de péage</label>
                        <input type="text" name="frais_peage" id="frais_peage" value="<?php echo $frais_peage ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Frais de repas</label>
                        <input type="text" name="frais_repas" id="frais_repas" value="<?php echo $frais_repas ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Frais d'hebergement</label>
                        <input type="text" name="frais_heber" id="frais_heber" value="<?php echo $frais_heber ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Nombre de kilomètre</label>
                        <input type="text" name="nb_km" id="nb_km" value="<?php echo $nb_km ?>" required>
                    </div>
                    <div class="field padding-bottom--24">
                        <label>Motif</label>
